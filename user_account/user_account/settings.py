...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'rafiqabubakar81@gmail.com'
EMAIL_HOST_PASSWORD = 'rumg fefo fxel bpcf'
...
AUTH_USER_MODEL = 'account.CustomUser'  # Replace 'myapp' with the actual app name
